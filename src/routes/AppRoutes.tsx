...
const JournalJCETPage = lazy(() => import('../pages/JournalJCETPage'));
...
const YRCClubPage = lazy(() => import('../pages/YRCClubPage'));
    ...
    <Suspense fallback={<div className="route-loader">Loading...</div>}>
      <Routes>
        <Route path="/" element={<MainLayout />}>
          ...
          <Route path="journal-jcet" element={<JournalJCETPage />} />
          ...
          <Route path="quick-links/yrc-club" element={<YRCClubPage />} />
