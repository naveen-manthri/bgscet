...
const GrievanceRedressalCell = () => {
  return (
    <main className="grievance-redressal-cell">
      ...
      <BulletSection   data={grievanceRedressalData.procedure}  />

      <div className="grievance-redressal-cell__button-row flex flex-center">
        <a href="https://docs.google.com/forms/d/e/1FAIpQLSfuXjnNeEcz5q7yYjYU3ZcfA5WQNHI6yEIGhYGq9mHVRkLHzQ/viewform?pli=1" className="committee-btn grievance-redressal-cell__button flex flex-center" target="_blank"  rel="noopener noreferrer" >
          Click Here
        </a>
      </div>
    </main>
